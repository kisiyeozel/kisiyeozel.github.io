...
<body>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                ...
                <h1>Hayalindeki<br>Hediyeyi Yarat</h1>
                <p>Monopoly'den takvimlere, defterlerden özel kutulara. Sevdikleriniz için biricik hediyler tasarlayın.</p>
        ...
        <div class="container">
            <div class="features-grid">
                ...
                <div class="feature-box">
                    ...
                    <p>En iyi malzemeler kullanıyoruz.</p>
                </div>
                <div class="feature-box">
                    <div class="feature-icon"><i class="fas fa-heart"></i></div>
                    <h4>Unutulmaz</h4>
                    <p>Anılarınız için mükemmel.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="products" id="products">
        <div class="container">
            <div class="section-header">
                <h2>Ürünlerimiz</h2>
                <p>İsteğinize göre kişiselleştirilebilen özel ürünler</p>
            </div>
    ...
    <section class="banner" id="about">
        <div class="container banner-content">
            ...
            <a href="#contact" class="btn btn-primary btn-lg">Bize Ulaşın</a>
        </div>
    </section>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-brand">
                    ...
                    <p>Kişiye özel ürünler ile unutulmaz hediyeler yaratıyoruz.</p>
